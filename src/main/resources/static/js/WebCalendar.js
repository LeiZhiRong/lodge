...
Calendar.prototype.draw = function() {
  ...
  mvAry[mvAry.length] = '        <th align="center" width="98%" nowrap="nowrap"><select  name="calendarYear" id="calendarYear" style="font-size:12px;height: 22px;border:0;"></select><select name="calendarMonth" id="calendarMonth" style="font-size:12px;height: 22px;border:0;';
  if (calendar.DateMode > pickMode['month']) {
    mvAry[mvAry.length] = 'display:none;';
  }//pickMode 精确到年时隐藏“月”
