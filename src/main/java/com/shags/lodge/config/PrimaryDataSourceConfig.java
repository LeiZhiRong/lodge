...
import com.shags.lodge.exception.exception.SqlException;
...
public class PrimaryDataSourceConfig {
    static final String REPO_PACKAGE = "com.shags.lodge.primary.dao";
    static final String ENTITY_PACKAGE = "com.shags.lodge.primary.entity";
