...
import com.shags.lodge.Vo.BillApplyInfoExportVo;
import com.shags.lodge.Vo.BillApplyInfoImportVo;
...
public class BillApplyInfoController {
    ...
    public ModelAndView index(Model model, HttpSession session) throws JsonProcessingException {
        ...
        List<HeaderColumns> columns = tableHeaderService.listHeaderColumns(user.getId(), "applyGrid", "com.shags.lodge.dto.BillApplyInfoDto");
        List<HeaderColumns> history = tableHeaderService.listHeaderColumns(user.getId(), "applyHistoryGrid", "com.shags.lodge.dto.BillApplyHistoryInfoDto");
