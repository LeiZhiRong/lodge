...
import com.shags.lodge.service.primary.IStationInfoService;
...
public class StationInfoController {
    ...
    public ModelAndView index(Model model) throws JsonProcessingException {
        List<HeaderColumns> columns = CmsUtils.getHeaderColumns("com.shags.lodge.primary.entity.StationInfo");
