...
public class BillApplyInfoDto {
    ...
    public String getHandle() {
        String editRow = "<a href=\"javascript:void(0)\" class='easyui-linkbutton' plain='true' onclick='editRow(&quot;" + this.id + "&quot;);' ><i class=\"fa fa-edit\"></i>编辑</a>";
        ...
        String deleteRow = "<a href=\"javascript:void(0)\" class='easyui-linkbutton' plain='true' onclick='deleteRow(&quot;" + this.id + "&quot;);' ><i class=\"fa fa-trash\"></i>删除</a>";
        return editRow + "&nbsp;&nbsp;" + copyRow + "&nbsp;&nbsp;" + deleteRow;
    }
    ...
    public BillApplyInfoDto(BillApplyInfo billApplyInfo) {
